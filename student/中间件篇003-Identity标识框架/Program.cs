...
builder.Services.AddDbContext<AlbertDbContext>(options => options.UseMySql("Data Source =localhost; Initial Catalog =school; User Id =root; Password =hzy86561527",new MySqlServerVersion(new Version("6.0.2"))));
